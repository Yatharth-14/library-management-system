...
public class LibraryController {
    public static void main(String[] args) {
        ...
        BookSortingService bookSortingService =new BookSortingService(bookRepo);
        ...
        if (librarianService.login(loginId, loginPass)) {
            ...
            while (!exit) {
                ...
                switch (choice) {
                    ...
                    case 10:
                        Book[] sortedByRating = bookSortingService.sortByRating();
                    ...
                    case 11:
                        Book[] sortedByIsbn = bookSortingService.sortByIsbn();
                    ...
                    case 12:
                        Book[] sortedByQuantity = bookSortingService.sortByQuantity();
